<template>
	<div class="page-wrapper">
		<div class="choice-wrapper">
			...
			<div class="choice-list clearfix">
				<div class="choice-item">
					<span class="choice-name">景区名称：</span>
					<el-input class="input-item" v-model="siteName" placeholder="请输入景区名称"></el-input>
				</div>
				<div class="choice-item">
					<span class="choice-name">所在地区：</span>
					<el-select class="input-item" filterable v-model="siteAddress" placeholder="请选择" filterable>
					<el-option
					  label="全部"
					  value="">
					</el-option>
				    <el-option
				      v-for="(item,index) in siteAddressList"
				      :key="index"
				      :label="item.label"
				      :value="item.value">
				    </el-option>
				...
				<div class="choice-item">
					<span class="choice-name">景区线上应用：</span>
					<el-select class="input-item" filterable v-model="siteType" placeholder="请选择">
					<el-option
					  label="全部"
					  value="">
					</el-option>
		...
		<div class="choice-result">
			<h3 class="choice-title">景区列表<i @click="query()" class="el-icon-refresh refresh-icon"></i></h3>
			<div class="reslut-list">
		      ...
		      <el-table-column
		        label="所在地区"
		        align="center">
		        <template slot-scope="scope">{{getAddrValue(scope.row.addr)}}</template>
		      </el-table-column>
		     <!--  <el-table-column
		        prop="durationPlay"
		        label="游玩时长"
		      ...
		      <el-table-column
		        ...
		        label="是否添加专属定制"
		        align="center">
		        <template slot-scope="scope">{{getTypeValue(scope.row.onlineModel)}}</template>
		      </el-table-column>
		      <el-table-column
		        label="操作"
		        align="center">
